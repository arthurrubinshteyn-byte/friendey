      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .glow {
          ...
          background: radial-gradient(ellipse at center, rgba(255,255,240,0.04) 0%, transparent 70%);
        }
        ...
        .nav-cta {
          font-size: 13px; font-weight: 500; color: #0C0C0B;
          background: #E8E6E0; border: none; padding: 9px 20px;
        ...
        .btn-primary {
          ...
          background: #F0EDE6; border: none; padding: 14px 32px;
          border-radius: 100px; cursor: pointer;
          font-family: 'DM Sans', sans-serif; transition: all 0.2s;
        ...
        .btn-secondary {
          font-size: 14px; color: #555; background: none; border: none;
          cursor: pointer; font-family: 'DM Sans', sans-serif;
        ...
        .preview-wrap {
          position: relative; z-index: 1;
          padding: 0 24px 120px; max-width: 1100px; margin: 0 auto;
        ...
        .features {
          position: relative; z-index: 1;
          padding: 80px 24px 120px; max-width: 1100px; margin: 0 auto;
        }
        .features-label {
          font-size: 10px; font-weight: 600; letter-spacing: 2px;
          text-transform: uppercase; color: #444; margin-bottom: 60px;
          text-align: center;
        }
        ...
        .feature-title { font-size: 15px; font-weight: 600; color: #D0CEC4; margin-bottom: 8px; letter-spacing: -0.2px; }
        ...
        .quote-text {
          ...
          color: #E8E6E0; max-width: 700px; margin: 0 auto 24px;
        ...
        footer {
          position: relative; z-index: 1;
          padding: 24px 48px; border-top: 1px solid rgba(255,255,255,0.06);
          display: flex; align-items: center; justify-content: space-between;
        }
        .footer-logo { font-size: 14px; font-weight: 700; color: #333; letter-spacing: -0.3px; }
        ...
        @media (max-width: 768px) {
          ...
          .preview-days { grid-template-columns: repeat(7, 1fr); }
          .preview-cols { grid-template-columns: repeat(7, 1fr); }
